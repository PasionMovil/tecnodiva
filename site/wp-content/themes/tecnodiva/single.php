<?php get_header(); ?>
            ...
            <div id="main">
                ...
                <div class="post-heading">
                    ...
                    <br>    <br>
<a class="me-interesa-button" href="http://www.interesante.com/goodies/me-interesa?url-type=<?php the_permalink() ?>&image-url=<?php $post_thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID),'large'); echo $post_thumbnail[0]; ?>&detail=Tecnodiva&hash=tecnodiva&counter=true">Me Interesa</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="http://www.interesante.com/js/goodies/buttons.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","interesante-boton");</script>
                </div>
...
/* TecnoDiva Top BoxBanner */
google_ad_slot = "5597461831";
google_ad_width = 336;
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                ...
                <div class="post-meta">
                    ...
                    <div class="post-meta-tags"><?php the_tags('<strong>' . __("Etiquetas", 'Avenue') . '</strong> <span class="meta-arrow">&raquo;</span> ',', '); ?></div>
                    <?php endif; ?>
                    
                    <?php if(get_option('pyre_categories') == 'On'): ?> 
                    <div class="post-meta-cats"><strong><?php _e('Publicado en', 'Avenue'); ?></strong> <span class="meta-arrow">&raquo;</span> <?php the_category(', ') ?></div>
                    <?php endif; ?> 
                </div>
    ...
    <div class="block full">
        <h3>Visitantes llegan a esta pagina buscando<span class="arrows">&raquo;</span></h3>
        <br /><br>
<center><script type="text/javascript"><!--
google_ad_client = "ca-pub-0579069280875606";
/* TecnoDiva Enlaces Footer */
google_ad_slot = "8738835831";
google_ad_width = 468;
google_ad_height = 15;
//-->
</script>
