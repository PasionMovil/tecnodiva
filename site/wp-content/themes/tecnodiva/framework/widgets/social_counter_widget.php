...
class Pyre_Social_Counter_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		<div class="social-item">
			...
			<span class="social-descrip"><?php _e('suscriptores', 'Avenue'); ?></span>
			<?php else: ?>
			<span class="social-count"><?php _e('SUSCRÍBETE', 'Avenue'); ?></span>
			<span class="social-descrip"><?php _e('a nuestro Feed', 'Avenue'); ?></span>
			<?php endif; ?>
		</div>
		...
		<div class="social-item">
			...
			<span class="social-descrip"><?php _e('Seguidores', 'Avenue'); ?></span>
		</div>
		<?php endif; ?>
