            ...
            <div id="main">
                ...
                <?php if(get_option('pyre_homepage_style') == 'magazine'): ?>
                    ...
                    <div class="block full">
                        <h3><?php _e('Últimos artículos', 'Avenue'); ?> <span class="arrows">&raquo;</span></h3>
...
/* TecnoDiva BoxBanner 2012 */
google_ad_slot = "3364533543";
google_ad_width = 300;
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
                    ...
                    <div class="block archive">
                        <h3>
                            <?php _e('Últimos artículos', 'Avenue'); ?>
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class('block-item-big'); ?>>
                            ...
                            <p><?php echo string_limit_words(get_the_excerpt(), 34); ?></p><a href='<?php the_permalink(); ?>' title='<?php the_title(); ?>' class="readmore"><?php _e('Leer más', 'Avenue'); ?> <span class="block-arrows">&raquo;</span></a>
                        </div>
                        <?php endwhile; endif; ?>
