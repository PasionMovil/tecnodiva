...
add_action( 'wptouch_admin_page_render_wptouch-admin-theme-settings', 'foundation_relatedposts_settings' );
...
function foundation_relatedposts_settings( $page_options ){
	wptouch_add_page_section(
		...
		array(
			wptouch_add_setting(
				...
				__( 'Enable display of related posts', 'wptouch-pro' ),
				'',
